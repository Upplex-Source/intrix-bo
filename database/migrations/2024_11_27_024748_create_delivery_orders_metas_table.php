...
class CreateDeliveryOrdersMetasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('delivery_orders_metas', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('delivery_orders_metas');
    }
}
