<?php
$measurement_unit_create = 'measurement_unit_create';
?>

<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">{{ __( 'template.add_x', [ 'title' => Str::singular( __( 'template.measurement_units' ) ) ] ) }}</h3>
    ...
    <div class="card-inner">
        <div class="row">
            <div class="col-md-12 col-lg-6">
                ...
                <div class="mb-3 row">
                    <label for="{{ $measurement_unit_create }}_title" class="col-sm-5 col-form-label">{{ __( 'measurement_unit.title' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="{{ $measurement_unit_create }}_title">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">
                    <label for="{{ $measurement_unit_create }}_description" class="col-sm-5 col-form-label">{{ __( 'measurement_unit.description' ) }}</label>
                    <div class="col-sm-7">
                        <textarea class="form-control" id="{{ $measurement_unit_create }}_description"></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                <div class="mb-3 row">
                ...
                <div class="mb-3">
                    ...
                    <div class="dropzone mb-3" id="{{ $measurement_unit_create }}_image" style="min-height: 0px;">
                ...
                <div class="text-end">
                    <button id="{{ $measurement_unit_create }}_cancel" type="button" class="btn btn-outline-secondary">{{ __( 'template.cancel' ) }}</button>
                    &nbsp;
                    <button id="{{ $measurement_unit_create }}_submit" type="button" class="btn btn-primary">{{ __( 'template.save_changes' ) }}</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        let fc = '#{{ $measurement_unit_create }}',
                fileID = '';
