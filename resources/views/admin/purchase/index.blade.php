<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">{{ __( 'template.purchases' ) }}</h3>
                ...
                <div class="toggle-expand-content" data-content="pageMenu">
                    <ul class="nk-block-tools g-3">
                        <li class="nk-block-tools-opt">
                            <a href="{{ route( 'admin.purchase.add' ) }}" class="btn btn-primary">{{ __( 'template.add' ) }}</a>
                        </li>
                    </ul>
                </div>
            </div>
...
$columns = [
    ...
    [
        'type' => 'input',
        'placeholder' =>  __( 'datatables.search_x', [ 'title' => __( 'purchase.reference' ) ] ),
        'id' => 'reference',
        'title' => __( 'purchase.reference' ),
    ],
    [
        'type' => 'input',
        'placeholder' =>  __( 'datatables.search_x', [ 'title' => __( 'purchase.supplier' ) ] ),
        'id' => 'supplier',
    ...
    [
        'type' => 'default',
        'id' => 'final_amount',
        'title' => __( 'purchase.final_amount' ),
    ],
    [
        'type' => 'default',
        'id' => 'paid_amount',
...
var statusMapper = @json( $data['status'] ),
    ...
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        $( document ).on( 'click', '.dt-status', function() {
            ...
            $.ajax( {
                url: '{{ route( 'admin.purchase.updatePurchaseStatus' ) }}',
                type: 'POST',
                data: {
                    'id': $( this ).data( 'id' ),
