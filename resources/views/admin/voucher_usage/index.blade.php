<div class="nk-block-head nk-block-head-sm">
    <div class="nk-block-between">
        <div class="nk-block-head-content">
            <h3 class="nk-block-title page-title">{{ __( 'template.voucher_usages' ) }}</h3>
...
$columns = [
    ...
    [
        'type' => 'input',
        'placeholder' =>  __( 'datatables.search_x', [ 'title' => __( 'voucher_usage.order' ) ] ),
        'id' => 'orders',
        'title' => __( 'voucher_usage.order' ),
    ],
    [
        'type' => 'input',
        'placeholder' =>  __( 'datatables.search_x', [ 'title' => __( 'voucher_usage.user' ) ] ),
        'id' => 'user',
        'title' => __( 'voucher_usage.user' ),
    ],
    [
        'type' => 'input',
        'placeholder' =>  __( 'datatables.search_x', [ 'title' => __( 'voucher_usage.title' ) ] ),
        'id' => 'title',
        'title' => __( 'voucher_usage.title' ),
    ],
    [
        'type' => 'select',
        'options' => $data['voucher_type'],
        'id' => 'voucher_type',
        'title' => __( 'voucher_usage.voucher_type' ),
    ],
    [
        'type' => 'select',
        'options' => $data['discount_types'],
        'id' => 'discount_type',
        'title' => __( 'voucher_usage.discount_type' ),
    ],
    [
        'type' => 'select',
        'options' => $data['status'],
...
var statusMapper = @json( $data['status'] ),
    ...
    dt_table_config = {
        ...
        ajax: {
            url: '{{ route( 'admin.voucher_usage.allVoucherUsages' ) }}',
            data: {
                '_token': '{{ csrf_token() }}',
            },
            dataSrc: 'voucher_usages',
        },
        ...
        columnDefs: [
            ...
            {
                targets: parseInt( '{{ Helper::columnIndex( $columns, "orders" ) }}' ),
                width: '10%',
                render: function( data, type, row, meta ) {
            ...
            },
            {
                ...
                render: function( data, type, row, meta ) {
                    ...
                    @canany( [ 'edit voucher_usages', 'delete voucher_usages' ] )
                    let edit, status = '';

                    @can( 'edit voucher_usages' )
