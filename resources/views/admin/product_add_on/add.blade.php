...
<?php
$product_add_on_create = 'product_add_on_create';
?>
        ...
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="mb-3">
                    ...
                    <div class="dropzone mb-3" id="{{ $product_add_on_create }}_image" style="min-height: 0px;">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_add_on_create }}_title" class="col-sm-5 form-label">{{ __( 'product_add_on.title' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="{{ $product_add_on_create }}_title">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="{{ $product_add_on_create }}_code" class="col-sm-5 form-label">{{ __( 'product_add_on.code' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="{{ $product_add_on_create }}_code">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                
                <div class="mb-3 row">
                    <label for="{{ $product_add_on_create }}_sku" class="col-sm-5 form-label">{{ __( 'product_add_on.sku' ) }}</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" id="{{ $product_add_on_create }}_sku">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="{{ $product_add_on_create }}_description" class="col-sm-5 form-label">{{ __( 'product_add_on.description' ) }}</label>
                    <div class="col-sm-7">
                        <textarea class="form-control" name="{{ $product_add_on_create }}_description" id="{{ $product_add_on_create }}_description" rows="5"></textarea>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>

                <div class="mb-3 row">
                    <label for="{{ $product_add_on_create }}_price" class="col-sm-5 form-label">{{ __( 'product_add_on.price' ) }}</label>
                    <div class="col-sm-7">
                        <input type="number" class="form-control" id="{{ $product_add_on_create }}_price">
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
                ...
                <div class="text-end">
                    <button id="{{ $product_add_on_create }}_cancel" type="button" class="btn btn-outline-secondary">{{ __( 'template.cancel' ) }}</button>
                    &nbsp;
                    <button id="{{ $product_add_on_create }}_submit" type="button" class="btn btn-primary">{{ __( 'template.save_changes' ) }}</button>
                </div>
            </div>
        </div>
    </div>
...
<script>
    document.addEventListener( 'DOMContentLoaded', function() {
        ...
        $( fc + '_submit' ).click( function() {
            ...
            $.ajax( {
                url: '{{ route( 'admin.product_add_on.createProductAddOn' ) }}',
                type: 'POST',
                data: formData,
                processData: false,
                contentType:   false,
