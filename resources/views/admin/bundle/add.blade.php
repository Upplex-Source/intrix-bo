        ...
        <div class="row">
            ...
            <div class="col-md-12 col-lg-6">
                ...
                <div class="col-sm-12 mb-3 row">
                    <label for="{{ $bundle_create }}_product" class="form-label">{{ __( 'template.menus' ) }}</label>
                    <select class="form-select" id="{{ $bundle_create }}_product" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'template.menus' ) ] ) }}" multiple="multiple">
                    </select>
                    <div class="invalid-feedback"></div>
                </div>
