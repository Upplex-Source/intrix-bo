    ...
    <div class="card-inner">
        <div class="row">
            <div class="col-md-12 col-lg-12">
                ...
                <div class="mb-3 row">
                    <label for="{{ $delivery_order_create }}_product" class="col-sm-5 form-label">{{ __( 'template.menus' ) }}</label>
                    <div class="col-sm-7">

                        <select class="form-select" id="{{ $delivery_order_create }}_product" data-placeholder="{{ __( 'datatables.select_x', [ 'title' => __( 'template.menus' ) ] ) }}" multiple="multiple">
                        </select>
                        <div class="invalid-feedback"></div>
                    </div>
                </div>
