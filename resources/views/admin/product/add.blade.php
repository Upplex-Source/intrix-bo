    ...
    <div class="card-inner">
        <div class="row">
            <div class="col-md-12 col-lg-6">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_product_type" class="col-sm-5 col-form-label">{{ __( 'product.product_type' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_product_code" class="col-sm-5 col-form-label">{{ __( 'product.product_code' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_barcode" class="col-sm-5 col-form-label">{{ __( 'product.barcode' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_brand" class="col-sm-5 col-form-label">{{ __( 'product.brand' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_category" class="col-sm-5 col-form-label">{{ __( 'product.category' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_supplier" class="col-sm-5 col-form-label">{{ __( 'product.supplier' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_workmanship" class="col-sm-5 col-form-label">{{ __( 'product.workmanship' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_address_1" class="col-sm-5 col-form-label">{{ __( 'product.address_1' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_address_2" class="col-sm-5 col-form-label">{{ __( 'product.address_2' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_city" class="col-sm-5 col-form-label">{{ __( 'product.city' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_state" class="col-sm-5 col-form-label">{{ __( 'product.state' ) }}</label>
                    <div class="col-sm-7">
                ...
                <div class="mb-3 row">
                    <label for="{{ $product_create }}_postcode" class="col-sm-5 col-form-label">{{ __( 'product.postcode' ) }}</label>
                    <div class="col-sm-7">
